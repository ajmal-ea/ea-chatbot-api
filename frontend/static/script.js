document.addEventListener('DOMContentLoaded', function() {
    ...
    const API_BASE_URL = window.EA_CHATBOT_CONFIG ? window.EA_CHATBOT_CONFIG.apiBaseUrl : 'http://localhost:8000';
    ...
    // Create history refresh button
    const historyButton = document.createElement('button');
    historyButton.id = 'history-button';
    historyButton.title = 'View chat history';
    historyButton.innerHTML = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 18 0 9 9 0 0 0-18 0z"></path><path d="M12 7v5l3 3"></path></svg>';
    ...
    function resetChat() {
        ...
        const welcomeMessage = window.EA_CHATBOT_CONFIG && window.EA_CHATBOT_CONFIG.welcomeMessage 
            ...
            : '<p>👋 Welcome to Express Analytics! How can I assist you today?</p>';
    ...
    function showHistoryPopup() {
        ...
        // Add loading class to history button
        ...
        fetch(`${API_BASE_URL}/history/${sessionId}`)
            ...
            .then(data => {
                ...
                // Briefly highlight the history button to indicate success
                if (historyButton) {
                    historyButton.classList.remove('loading');
                    historyButton.classList.add('highlight-button');
                    setTimeout(() => {
                        historyButton.classList.remove('highlight-button');
                    }, 1500);
                }
            })
            .catch(error => {
                ...
                // Remove loading class from history button
                if (historyButton) {
                    historyButton.classList.remove('loading');
                }
            });
